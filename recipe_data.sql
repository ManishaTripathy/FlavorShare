...
In a bowl, whisk egg yolks with the condensed milk, lime juice and salt until smooth. Pour the filling into the cooled crust and transfer to the oven. Immediately lower the oven temperature to 325°. Bake the pie for 20 to 25 minutes, until set around the edge and slightly jiggly in the center. Let cool to room temperature, then refrigerate until firm, at least 6 hours or overnight.<br/><br/>
Step 3 : Mound the whipped cream decoratively on the pie and garnish with Key lime slices. Cut into wedges and serve, passing additional unsweetened whipped cream at the table.<br/><br/>
Pro-Tip : MAKE AHEAD The key lime pie can be refrigerated for up to 3 days.<br/><br/>',3,75,8);

insert into recipes values(203,303,'Funfetti Gooey Cake Bars','1. Preheat oven to 350 degrees F. Line a 9x9-inch baking pan with aluminum foil and spray with cooking spray. Set aside.<br/><br/>
2. Using an electric mixer, beat the cake mix, butter, and egg together on medium speed until a thick dough forms. Add in 1/3 cup of the sprinkles and mix on low just until incorporated.<br/><br/>
3. Press about 2/3 of the dough into the bottom of the prepared baking pan. Sprinkle the white chocolate chips and the remaining 1/3 cup of sprinkles on top. Pour the sweetened condensed milk evenly over the top. Separate the remaining dough into small balls and evenly space over the top.<br/><br/>
4. Bake for 30 minutes, or until they just begin to brown. Cool completely before slicing. Enjoy!<br/><br/>',4,55,4);
...
2. Add cubed squash, onion, garlic and red pepper flakes to the skillet. Season with salt and pepper. Cook, stirring occasionally, until onion is translucent, or about 10 minutes.<br/><br/>
3. Add in your low-sodium vegetable broth. Bring the mixture to a boil, then cover and reduce heat, simmering until squash is soft and broth is reduced by half. This should take about 20 minutes.<br/><br/>
4. In the meantime, bring a large pot of salted water to a boil and cook the pasta according to package directions, stirring occasionally, until al dente.<br/><br/>
5. In a blender, combine cashews, water, lemon juice, and salt. Process on high until very smooth, or about 2 minutes. Pour into a separate dish and set aside.<br/><br/>
6. Once the squash mixture is done cooking, remove it from heat and let it cool slightly. Transfer the contents of the pan to a blender, and purée the mixture until smooth.<br/><br/>
7. When finished, return squash purée to the skillet and whisk in your cashew cream sauce. Season with salt and pepper to taste.<br/><br/>
8. Combine pasta and squash purée until sauce coats pasta, seasoning with additional salt and pepper if necessary.<br/><br/>
9. Serve pasta topped with fried sage and additional red pepper flakes if desired.<br/><br/>',4,60,3);

insert into recipes values(207,301,'Crispy Baked Honey Garlic Chicken','1. Preheat oven to 400 degrees F. Lightly grease a large baking sheet, or cover with parchment paper.<br/><br/>
2. In separate shallow dishes, place beaten eggs and panko breadcrumbs. In batches, dip chicken into eggs (shaking off excess), then coat in crumbs, pressing to coat.<br/><br/>
3. Place pieces on baking sheet. Bake until golden brown and crisp, about 15 minutes.<br/><br/>
4. Meanwhile, in a medium saucepan set to medium-high heat, whisk honey, soy sauce, Sriracha and garlic powder. In a small bowl, combine cornstarch and 1/3 cup water. Stir mixture into saucepan until thickened, about 1-2 minutes. Pour over chicken and gently toss to combine.<br/><br/>
5. Serve immediately over rice, topped with green onions and sesame seeds, if desired.<br/><br/>',5,40,4);

insert into recipes values(208,301,'Sweet and Spicy Tofu','1. After pressing the tofu, carefully cut into one inch cubes<br/><br/>
2. Put cubed tofu and cornstarch into a large quart or gallon sized ziploc bag and shake gently until all tofu is coated<br/><br/>
3. Let sit for 20 to 30 minutes<br/><br/>
4. In the meantime, mix soy sauce, Sriracha, maple syrup and rice vinegar together in a small bowl and set aside<br/><br/>
5. Heat oil in a large frying pan over medium/ high heat<br/><br/>
6. Fry tofu cubes in oil, turning to cook all sides until golden brown<br/><br/>
7. Once tofu is cooked, remove from heat and add sauce, stirring to coat all pieces<br/><br/>',3,65,4);

insert into recipes values(209,302,'Spinach Artichoke Dip','1. Preheat the oven to 375F.<br/><br/>
2. Combine all of the ingredients except ¼ cup Parmesan in a large bowl. Mix well to evenly combine.<br/><br/>
3. Transfer the dip to a large baking dish and top with the remaining Parmesan cheese. Bake until golden and bubbly about 30 minutes.<br/><br/>
4. Serve with pita chips.<br/><br/>',4,35,6);

insert into recipes values(210,302,'Basic Baked French Fries Recipe','1. Preheat oven to 425 degrees.<br/><br/>
2. In a large bowl toss the potatoes and the oil until evenly coated. <br/><br/>
3. Spread on one to two baking sheets so the fries are in a single layer.<br/><br/>
4. Place in the oven and turn after 15 minutes. <br/><br/>
5. Cook until the fries become golden brown about another 10 to 15 minutes depending on how thick you sliced them.<br/><br/>
6.Remove and sprinkle with salt, pepper and fresh chopped parsley.<br/><br/>',4,30,6);

insert into recipes values(211,302,'Colcannon','1. Wash and quarter the red potatoes. Smack the garlic cloves with the side of a kitchen knife to open and place in a large stockpot or Dutch oven with the potatoes and cover with water. Add kosher salt and bring to a boil over high heat, cook until fork tender. Drain and set aside.<br/><br/>
2. Return pan to medium-high heat, cook and render the bacon until crisp. Set aside to cool slightly and chop. Keep bacon fat in pan, add the cabbage and kale and cook until wilted, about 5 minutes.Add the potatoes back to the pan. Add the milk, cream, and black pepper, and bring to a boil. <br/><br/>
3. Using a potato masher, mash and stir potatoes until smooth and thoroughly incorporated with cabbage and kale. Add the bacon crumbles and season with kosher salt if needed. Transfer to a bowl, top with chopped chives and serve hot with butter on top.<br/><br/>',5,30,4);

insert into recipes values(212,302,'Hot and Spicy Buffalo Shrimp Dip','1. Preheat oven to 375°. Lightly spray an 8 x 8 or 9 x 9 baking dish, or even a pie dish with cooking spray.<br/><br/>
2. Combine the first 4 ingredients together and 1/4 cup of the cheese; mix until smooth. <br/><br/>
